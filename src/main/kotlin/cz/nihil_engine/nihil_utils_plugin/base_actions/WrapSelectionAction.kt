...
abstract class WrapSelectionAction : AnAction, DumbAware {
    constructor() : super()
    constructor(text: String?, description: String?) : super(text, description, null)

    // using main UI thread
    override fun getActionUpdateThread() = ActionUpdateThread.EDT
    abstract val wrapStart: String
    abstract val wrapEnd: String
    ...
    override fun actionPerformed(event: AnActionEvent) {
        ...
        WriteCommandAction
            ...
            .withGlobalUndo()
            .run<Exception> {
                document.insertString(caret.selectionStart, wrapStart + '\n')
